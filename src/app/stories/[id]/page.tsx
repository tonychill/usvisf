...
import { mockGetStory, getContent } from "@/apis";

export default function Story({ params: { id } }: { params: { id: string } }) {
  let story = mockGetStory(id);
  useEffect(() => {
    getContent({ id: "1bPnBFPo5WvQL2fasxuO3Q" })
      .then((data) => {
  ...
  let { title, description, mainImageUrl, author, date } = story;
  return (
    <div className="mt-12 px-6 py-32 lg:px-8">
      <div className="mx-auto max-w-3xl text-base leading-7 text-gray-700">
        <p className="hidden text-base font-semibold leading-7 text-indigo-600">
          Introducing
        </p>
        ...
        <figure className="mt-16">
          <img
            ...
            alt=""
          />
          <figcaption className="hidden _flex mt-4 gap-x-2 text-sm leading-6 text-gray-500">
            <InformationCircleIcon
